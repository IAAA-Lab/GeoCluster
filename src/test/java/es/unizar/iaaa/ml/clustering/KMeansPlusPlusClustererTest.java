...
/**
 * This class contains the unit tests that check the correctness of the
 * k-means++ algorithm.
 * 
 * @author Javier Beltran
 */
public class KMeansPlusPlusClustererTest extends KMeansTest {
	...
	public void testNoClustersAreEmpty() throws Exception {
		...
		int k = 10;
		noClustersAreEmpty(new KMeansPlusPlusClusterer(k, distance, builder, params));
	}
	...
	public void testNumberOfClusters() throws Exception {
		...
		int k = 5;
		numberOfClusters(new KMeansPlusPlusClusterer(k, distance, builder, params), k);
	}
